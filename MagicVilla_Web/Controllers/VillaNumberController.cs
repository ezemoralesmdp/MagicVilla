...
namespace MagicVilla_Web.Controllers
{
    public class VillaNumberController : Controller
    {
        ...
        public async Task<IActionResult> IndexVillaNumber()
        {
            ...
            var response = await _villaNumberService.GetAll<APIResponse>(HttpContext.Session.GetString(DS.SessionToken));
        ...
        public async Task<IActionResult> CreateVillaNumber(VillaNumberViewModel model)
        {
            ...
            {
                var response = await _villaNumberService.Create<APIResponse>(model.VillaNumber, HttpContext.Session.GetString(DS.SessionToken));
                if(response != null && response.IsSuccessful)
                {
        ...
        public async Task<IActionResult> UpdateVillaNumber(int villaNo)
		{
			...
			var response = await _villaNumberService.Get<APIResponse>(villaNo, HttpContext.Session.GetString(DS.SessionToken));
        ...
        public async Task<IActionResult> UpdateVillaNumber(VillaNumberUpdateViewModel model)
        {
            if (ModelState.IsValid)
            {
                var response = await _villaNumberService.Update<APIResponse>(model.VillaNumber, HttpContext.Session.GetString(DS.SessionToken));
                if (response != null && response.IsSuccessful)
                {
        ...
        {
            var response = await _villaNumberService.Remove<APIResponse>(model.VillaNumber.VillaNo, HttpContext.Session.GetString(DS.SessionToken));
